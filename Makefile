...
ifeq ($(config),debug_x64)
  TicTacToe_config = debug_x64
  raylib_config = debug_x64

else ifeq ($(config),debug_x86)
  TicTacToe_config = debug_x86
  raylib_config = debug_x86

else ifeq ($(config),debug_arm64)
  TicTacToe_config = debug_arm64
  raylib_config = debug_arm64

else ifeq ($(config),release_x64)
  TicTacToe_config = release_x64
  raylib_config = release_x64

else ifeq ($(config),release_x86)
  TicTacToe_config = release_x86
  raylib_config = release_x86

else ifeq ($(config),release_arm64)
  TicTacToe_config = release_arm64
...
ifneq (,$(TicTacToe_config))
	...
	@${MAKE} --no-print-directory -C build/build_files -f TicTacToe.make config=$(TicTacToe_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f TicTacToe.make clean
